...
$Assunto		= $_POST["contactSubject"];	// Pega o valor do campo Telefone
...
o nome do email que envia a mensagem, o Assunto da mensagem e por último a variável com o corpo do email.
 ...
 if (smtpmailer('losmacacos@gmail.com', 'kungfuatibaia2@gmail.com', 'Contato', 'Assunto', $Vai)) {

	Header("location:http://kungfucadastro.herokuapp.com"); // Redireciona para uma página de obrigado.
